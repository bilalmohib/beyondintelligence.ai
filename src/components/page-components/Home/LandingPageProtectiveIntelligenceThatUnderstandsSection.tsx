  ...
  return (
    <div className="bg-primary">
      <Container className="min-h-fit pt-12 md:pt-18 pb-0 lg:pt-24 lg:px-15 flex flex-col gap-8 md:gap-14 lg:gap-16">
        <Heading2 className="text-white! text-center! leading-normal md:leading-13.75! -tracking-[0.92px]!">
        ...
        <div className="grid grid-cols-1 mllg:grid-cols-2 gap-8 md:gap-12 lg:gap-16">
          <div className="flex flex-col justify-center items-center">
            <div className="h-fit flex flex-col gap-4 md:gap-6 lg:gap-8">
              <Heading3 className="text-white! text-left! leading-normal! md:leading-10! text-xl! md:text-2xl! mllg:text-3xl! lg:text-[32px]! -tracking-[0.64px]!">
                How Satori Appears in Your Life
              </Heading3>
              <div className="flex flex-col gap-3">
                <Paragraph className="text-white! text-left! leading-normal! md:leading-7!">
