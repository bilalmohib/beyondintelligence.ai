...
const FiveEnvironmentalForcesModalContent = ({ title, description, bottomText, image }: IFiveEnvironmentalForcesModalContentProps) => {
    return (
        <>
            <div
                className="flex min-h-0 flex-1 flex-col justify-between gap-1 overflow-auto bg-white p-3 pt-14 pr-14 sm:p-4 sm:pt-14 sm:pr-14 md:w-[55%] md:flex-initial md:gap-4 md:p-8 md:pt-8 md:pr-8 lg:p-10 xl:p-12 rounded-t-[20px] md:rounded-l-[20px] md:rounded-tr-none md:rounded-br-none md:rounded-t-none"
            >
            ...
            <div
                className="relative min-h-0 flex-1 w-full md:flex-initial md:h-full md:w-[45%] rounded-b-[20px] md:rounded-b-none md:rounded-r-[20px] md:rounded-l-none"
            >
                <Image
                    src={image.src}
                    alt={image.alt}
