...
interface LandingPageSatoriBlogsSliderProps {
  slides: SlideData[];
...
const LandingPageSatoriBlogsSlider = ({
  slides,
  imageHeight,
  isModalActive = false,
  onSlideSelect,
  fullWidth = false,
}: LandingPageSatoriBlogsSliderProps) => {
...
export default LandingPageSatoriBlogsSlider;
