...
const SCROLL_THRESHOLD = 100; // accumulated wheel delta before triggering animation

const ChildsLifeBiggerTransitionScroll = () => {
    ...
    useEffect(() => {
        const handleWheel = (e: WheelEvent) => {
            if (!isTransitioned) {
                // Scroll down to show second animation
                if (e.deltaY > 0) {
                ...
                // Scroll up to go back to first animation
                if (e.deltaY < 0) {
...
export default ChildsLifeBiggerTransitionScroll;
