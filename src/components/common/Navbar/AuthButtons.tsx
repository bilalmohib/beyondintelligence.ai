...
const AuthButtons = () => {
  return (
    <div className="flex items-center gap-6 flex-row w-full">
      ...
      <Button
        type="button"
        className="items-center justify-center w-full md:w-[157px] h-[47px] bg-primary hover:bg-primary/90 text-white font-inter text-base font-bold leading-none tracking-[0.09em] rounded-[5px] transition-colors duration-200 hidden mlg:inline-flex"
      >
        Get Started
      </Button>
    </div>
